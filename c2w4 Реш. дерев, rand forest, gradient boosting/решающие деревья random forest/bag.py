...
# For Stumble Kaggle competition
# Contributor: Jean-Francois Veillette 
# Modified so it can be used with sklearn 14.1 directly
# in current code or current working directory, tested with 2.7.5
...
from sklearn.base import clone, BaseEstimator, ClassifierMixin, RegressorMixin, MetaEstimatorMixin
